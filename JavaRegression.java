//Sourced from https://algs4.cs.princeton.edu/code/edu/princeton/cs/algs4/LinearRegression.java.html
...
public class JavaRegression {
    ...
    public JavaRegression(double[] x, double[] y) {
...
System.out.println(String.format("Committed memory: %.2f", 
  (double)memoryMXBean.getHeapMemoryUsage().getCommitted()));
        ...
        JavaRegression jr=new JavaRegression(x,y);
        System.out.println(jr.toString());
        System.out.println(jr.predict(1729));
