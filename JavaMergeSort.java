...
System.out.println(String.format("Committed memory: %.2f", 
  (double)memoryMXBean.getHeapMemoryUsage().getCommitted()));
        ...
        JavaMergeSort ob = new JavaMergeSort(); 
